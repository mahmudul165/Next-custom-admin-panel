...
const AppointmentComponent = dynamic(() =>
  import("/components/patient-cancel-appointment/AppointmentComponent.js")
);
    ...
    <>
      ...
      <main className="p-6  space-y-6">
        <AppointmentComponent
          title="Therapist cancel appointment"
                ...
                <MaterialReactTable
                  ...
                  renderRowActions={({ row }) => (
                    ...
                    >
                      ...
                      <View url={`appointment/view/${row.original.id}`} />
                      <Edit url={`appointment/edit/${row.original.id}`} />
                      ...
                      /> */}
                      <Delete
                        url={`https://misiapi.lamptechs.com/api/v1/appointment/delete/${row?.original?.id}`}
                      />
                    </div>
                  )}
                />{" "}
