      ...
      setRemoteData(
        json.data.filter((item) => {
          return (
            ...
            (item?.department?.name !== "Screener Group"
              ...
              <>
                ...
                <MaterialReactTable
                  ...
                  renderRowActions={({ row }) => (
                    ...
                    >
                      <View url={`screener-group/view/${row.original.id}`} />
                      <Edit url={`screener-group/edit/${row.original.id}`} />
                      <Assigned
