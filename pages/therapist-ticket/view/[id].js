...
function EditTicket() {
  ...
  const { data: ticketHistory } = useAllTicketHistoryQuery();
  ...
  console.log("All ticket history  data  from  ", ticketHistory);
  console.log("id", router?.query?.id);
  const singleTicketHistory = ticketHistory?.data?.filter(
    (item) => item?.ticket_id == router?.query?.id
    // (router?.query?.id || localStorage.setItem("lastId", router.query?.id))
  );
  console.log("single ticket history  data  from  ", singleTicketHistory);
  return (
    <>
      {singleTicket ? (
        <>
              ...
              <table className="w-full text-left text-sm text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                  ...
                  <tr className="border-b bg-white dark:border-gray-700 dark:bg-gray-800">
                    ...
                    <td className="px-2 py-2">{`${singleTicket?.assign_to_user}`}</td>
                  </tr>
                  <tr className="border-b bg-white dark:border-gray-700 dark:bg-gray-800">
                    <th
                      scope="row"
                    ...
                    <td className="px-2 py-2">{`${singleTicket?.assign_to_user_status}`}</td>
                  </tr>
                  {/* <tr className="border-b bg-white dark:border-gray-700 dark:bg-gray-800">
                    <th
                      scope="row"
                    ...
                    <td className="px-2 py-2">{`${singleTicket?.user_department}`}</td>
                  </tr> */}
                  <tr className=" border-b bg-white dark:border-gray-700 dark:bg-gray-800">
                    <th
                      scope="row"
                  ...
                  <tr className=" border-b bg-white dark:border-gray-700 dark:bg-gray-800">
                    ...
                    <td className="px-2 py-2">{`${singleTicket?.strike}`}</td>
                  </tr>
                  <tr className=" border-b bg-white dark:border-gray-700 dark:bg-gray-800">
                    <th
                      scope="row"
            ...
            <div className="col-md-6  border-l-2">
              <table className="w-full text-left text-sm text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                  ...
                  <tr className="border-b  bg-white dark:border-gray-700 dark:bg-gray-800">
                    <td className="px-2 py-2">{`${singleTicket?.comment}`}</td>
                  </tr>
                  {/* ticket log */}
                  {/* <tr className="   bg-white dark:border-gray-700 dark:bg-gray-800">
                      <th
