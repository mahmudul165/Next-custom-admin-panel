      ...
      {singleTicket ? (
        <form
          ...
          onSubmit={handleSubmit(
            ...
            //   "https://misiapi.lamptechs.com/api/v1/ticket/update",
            //   d,
            //   "https://misiapi.lamptechs.com/api/v1/tickethistory/store",
            //   {
            //     ticket_id: `${singleTicket?.data?.id}`,
            //     // group_id,
            //     // assign_to_user,
            //     // name,
            //     // email,
            //     // department,
            //     assign_to_therapist: "jony",
            //     appointment_group: group_id,
            //     call_strike: "5",
            //     strike_history: "hfd",
            //     ticket_history: "gfgf",
            //     language: "bangla",
            //     assign_to_user: name,
            //     assign_to_user_status: "inactive",
            //     deleted_by: "Delete by zilan",
            //     deleted_date: "2021-5-3",
            //     status: "P",
            //     remarks: "remark",
            //     modified_by: name,
            //     modified_date: "2022-5-3",
            //     created_by: "test_create",
            //     created_date: "2021-8-4",
            //   }
            // )
                ...
                <div className=" col-md-6    ">
                  ...
                  <>
                    <div className="d-flex flex-column align-items-center text-center px-3   ">
                      ...
                      />
                      <span className="font-weight-bold text-xl mt-2 ">
                        {`${singleTicket?.data?.patient_info?.first_name} ${singleTicket?.data?.patient_info?.last_name}`}
                      </span>
                      <span className="text-lg my-1.5 text-teal-500 font-medium ">
                        ...
                        <tr className="border-b bg-white dark:border-gray-700 dark:bg-gray-800">
                          ...
                          <td className="px-3 py-2.5">
                            <input
                              ...
                              className=""
                              placeholder="  "
                              value={`${singleTicket?.data?.assign_to_user}`}
                              required
                            />
                            {/* {`${singleTicket?.data?.patient_info?.source}`} */}
                          </td>
                        ...
                        <tr className="border-b bg-white dark:border-gray-700 dark:bg-gray-800">
                          ...
                          <td className="px-3 py-2.5">
                            <input
                              ...
                              {...register("assign_to_user_status")}
                              className=""
                              placeholder="  "
                              value={`${singleTicket?.data?.assign_to_user_status}`}
                              required
                            />
                            {/* {`${singleTicket?.data?.patient_info?.source}`} */}
                          </td>
                ...
                <div className="col-md-6  border-l-2">
                  ...
                  <div className="relative  mt-2.5">
                    ...
                    <textarea
                      ...
                      // onChange={onChange}
                      name="comment"
                      defaultValue={singleTicket?.data?.comment}
                    />
                    <label
                      htmlFor="comment"
                      className="absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-white dark:bg-gray-800 px-2 peer-focus:px-2 peer-focus:text-teal-500 peer-focus:dark:text-teal-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 left-1"
