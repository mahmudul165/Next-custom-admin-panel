  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      const response = await fetch(
        `https://misiapi.lamptechs.com/api/v1/therapist/show?id=${pathId}`,
      ...
      {singleTherapist ? (
        <div className="container   mx-4  px-12  rounded bg-white mt-5 mb-5 ">
          <div className="container   mx-4  p-12  rounded bg-white mt-5 mb-5 ">
            <div className="grid  gap-48 mt-2.5 items-center  ">
              <h2
            ...
            >
              <div className=" col-md-4    ">
                <div className="d-flex flex-column align-items-center text-center px-3">
                  ...
                  <span className="text-lg mt-2 text-teal-500 font-medium">{`${singleTherapist?.email}`}</span>
                  <span> </span>
                </div>
                {/* start */}
                ...
                <table className="w-full text-left text-sm text-gray-500 dark:text-gray-400 mt-3">
                  ...
                  <tbody>
                    <tr className="border-b bg-white dark:border-gray-700 dark:bg-gray-800">
                      <th
                        scope="row"
                        className="whitespace-normal px-2 py-2.5 font-bold text-black dark:text-white"
                      >
                        Phone:
                      </th>
