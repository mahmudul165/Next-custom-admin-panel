...
const TicketComponent = dynamic(() =>
  import("../../components/heraanmelding/TicketComponent")
);
      ...
      setRemoteData(
        json.data.filter((item) => {
          return (
            ...
            (item?.department?.name !== "Heraanmelding"
              ...
              <>
                {remoteData?.length && (
                  <div className="flex items-end justify-end">
                    <CSVLink
                      filename="heraanmelding-group.csv"
                      data={parsedData}
                ...
                <MaterialReactTable
                  ...
                  renderRowActions={({ row }) => (
                    ...
                    >
                      <View
                        url={`heraanmelding-group/view/${row.original.id}`}
                      />
                      <Edit
                        url={`heraanmelding-group/edit/${row.original.id}`}
                      />
                      <Assigned
