              ...
              <>
                ...
                <MaterialReactTable
                  ...
                  renderRowActions={({ row }) => (
                    ...
                    >
                      <View
                        url={`therapist-appointment/view/${row.original.id}`}
                      />
                      <Edit
                        url={`therapist-appointment/edit/${row.original.id}`}
                      />
                      ...
                      <Cancel
                        url={`https://misiapi.lamptechs.com/api/v1/appointmentticketstatus`}
                        data={{
                          id: `${row?.original?.id}`,
