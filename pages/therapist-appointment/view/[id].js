  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      const response = await fetch(
        `https://misiapi.lamptechs.com/api/v1/appointment/show?id=${pathId}`,
              ...
              <div className=" col-md-5    ">
                <div className="d-flex flex-column align-items-center text-center px-3  ">
                  <img
                    ...
                    width="180px"
                    src={`${
                      singlePatient?.patient_info?.image_url !==
                  ...
                  /> */}
                  <span className="font-weight-bold text-xl">{`${singlePatient?.patient_info?.first_name} ${singlePatient?.patient_info?.last_name}`}</span>
                  <span className="mb-2 text-teal-500 font-medium">{`${singlePatient?.patient_info?.email}`}</span>
                  <span> </span>
                </div>
                {/* start */}
                ...
                <table className="w-full text-left text-sm text-gray-500 dark:text-gray-400">
                  ...
                  <tbody>
                    ...
                    <tr className="border-b bg-white dark:border-gray-700 dark:bg-gray-800 my-3">
                      ...
                      <td className="px-3 py-2.5">{`${singlePatient?.number}`}</td>
                    </tr>
                    <tr className="border-b bg-white dark:border-gray-700 dark:bg-gray-800 my-3">
                      <th
                        scope="row"
                      ...
                      <td className="px-3 py-2.5">{`${singlePatient?.therapist_info?.first_name} ${singlePatient?.therapist_info?.last_name}`}</td>
                    </tr>
                    <tr className="border-b bg-white dark:border-gray-700 dark:bg-gray-800">
                      ...
                      <td className="px-3 py-2.5">{`${singlePatient?.time}`}</td>
                    </tr>
                    <tr className="border-b bg-white dark:border-gray-700 dark:bg-gray-800">
                      <th
                        scope="row"
                      ...
                      <td className="px-3 py-2.5">{`${singlePatient?.fee}`}</td>
                    </tr>
                    <tr className="border-b bg-white dark:border-gray-700 dark:bg-gray-800">
                      <th
                        scope="row"
                      ...
                      <td className="px-3 py-2.5">{`${singlePatient.type}`}</td>
                    </tr>
                    <tr className="border-b bg-white dark:border-gray-700 dark:bg-gray-800">
                      <th
                        scope="row"
                      ...
                      <td className="px-3 py-2.5">
                        {`${singlePatient.therapist_schedule?.consulting_time}`}
                      </td>
                    </tr>
                    <tr className="border-b bg-white dark:border-gray-700 dark:bg-gray-800">
                      <th
                      ...
                      <td className="px-3 py-2.5">{`${singlePatient.therapist_schedule?.schedule_day}`}</td>
                    </tr>
                    ...
                    <tr className="border-b bg-white dark:border-gray-700 dark:bg-gray-800">
                      ...
                      <td className="px-3 py-2.5">{`${singlePatient?.patient_info?.phone}`}</td>
                    </tr>
                    <tr className="border-b bg-white dark:border-gray-700 dark:bg-gray-800">
                      <th
                        scope="row"
                      ...
                      <td className="px-3 py-2.5">{`${singlePatient?.therapist_info?.phone}`}</td>
                    </tr>
                    ...
                    <tr className="border-b bg-white dark:border-gray-700 dark:bg-gray-800">
                      ...
                      <td className="px-3 py-2.5">{`${singlePatient.blood_group?.patient_info?.name}`}</td>
                    </tr>
                    <tr className="border-b bg-white dark:border-gray-700 dark:bg-gray-800">
                      <th
                        scope="row"
                      ...
                      <td className="px-3 py-2.5">{`${singlePatient?.patient_info?.age}`}</td>
                    </tr>
                    <tr className="border-b bg-white dark:border-gray-700 dark:bg-gray-800">
                      <th
                        scope="row"
                      ...
                      <td className="px-3 py-2.5">{`${singlePatient?.patient_info?.dob_number}`}</td>
                    </tr>
                    <tr className="border-b bg-white dark:border-gray-700 dark:bg-gray-800">
                      <th
                        scope="row"
                      ...
                      <td className="px-3 py-2.5">{`${singlePatient?.patient_info?.marital_status}`}</td>
                    </tr>
                    <tr className="border-b bg-white dark:border-gray-700 dark:bg-gray-800">
                      <th
                        scope="row"
                      ...
                      <td className="px-3 py-2.5">{`${singlePatient?.patient_info?.occupation}`}</td>
                    </tr>
                    <tr className="border-b bg-white dark:border-gray-700 dark:bg-gray-800">
                      <th
                        scope="row"
                      ...
                      <td className="px-3 py-2.5">{`${singlePatient?.patient_info?.date_of_birth}`}</td>
                    </tr>
                    <tr className="border-b bg-white dark:border-gray-700 dark:bg-gray-800">
                      <th
                        scope="row"
                      ...
                      <td className="px-3 py-2.5">{`${singlePatient?.patient_info?.remarks}`}</td>
                    </tr>
                  </tbody>
                </table>
                ...
                <table className="w-full text-left text-sm text-gray-500 dark:text-gray-400">
                  ...
                  <tbody>
                    ...
                    <tr className="border-b bg-white dark:border-gray-700 dark:bg-gray-800">
                      ...
                      <td className="px-3 py-2.5">{`${Statustest(
                        singlePatient?.status
                      )}`}</td>
                    </tr>
                    <tr className="  bg-white dark:border-gray-700 dark:bg-gray-800">
                      <th
                    ...
                    <tr className="border-b bg-white dark:border-gray-700 dark:bg-gray-800">
                      <td className="px-3 py-2.5">
                        {`${singlePatient?.patient_info?.medical_history}`}
                      </td>
                    </tr>
                    <tr className="  bg-white dark:border-gray-700 dark:bg-gray-800">
                      <th
                    ...
                    <tr className="border-b bg-white dark:border-gray-700 dark:bg-gray-800">
                      <td className="px-3 py-2.5">
                        {`${singlePatient?.therapist_comment}`}
                      </td>
                    </tr>
                  </tbody>
                </table>
