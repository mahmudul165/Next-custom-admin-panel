...
const NavItem = ({
  ...
  return (
    <>
      <Link href={hrefLink}>
        <span
          className="inline-flex items-center justify-between px-3 py-2.5 hover:text-gray-400 hover:bg-stone-200 focus:text-gray-400 focus:bg-gray-700 rounded-lg   cursor-pointer relative group"
