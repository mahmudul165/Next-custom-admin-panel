...
// const PageTherapistComponentTitle = ({
//   title,
//   titleDescription,
//   buttonTitle,
// }) => {
...
//             viewBox="0 0 24 24"
//             stroke="currentColor"
//             className="flex-shrink-0 h-6 w-6 text-white -ml-1 mr-1"
//           >
//             <path
//               strokeLinecap="round"
...
// export default PageTherapistComponentTitle;
...
const TherapistComponent = ({ title, titleDescription, buttonTitle }) => {
      ...
      <div className="grid grid-cols-3 card  rounded-lg py-3 px-2 border-b-2 border-slate-200">
        ...
        <div className="flex flex-wrap items-start justify-end -mb-3">
          ...
          <OperationModal modal={modal} setModal={setModal}>
            {<TherapistForm className="m-auto" />}
          </OperationModal>
        </div>
      </div>
    </>
